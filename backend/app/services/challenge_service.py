...
class ChallengeService:
    ...
    def _load_templates(self) -> List[Dict]:
        ...
        return [
            ...
            {'title': 'FizzBuzz', 'description': 'Print numbers 1 to n. For multiples of 3 return Fizz. For multiples of 5 return Buzz. For both return FizzBuzz.', 'difficulty': 'beginner', 'domain': 'math', 'constraints': {'input_size': '1 ≤ n ≤ 10000'}, 'input_format': 'Single integer n', 'output_format': 'Array or space-separated list of strings', 'example_input': '5', 'example_output': '1 2 Fizz 4 Buzz', 'time_limit_seconds': 1, 'test_cases': [{'id': 'tc1', 'input': '5', 'expected_output': '1 2 Fizz 4 Buzz', 'category': 'basic', 'description': 'Basic 5', 'is_hidden': False}, {'id': 'tc2', 'input': '15', 'expected_output': '1 2 Fizz 4 Buzz Fizz 7 8 Fizz Buzz 11 Fizz 13 14 FizzBuzz', 'category': 'basic', 'description': 'Up to 15', 'is_hidden': False}, {'id': 'tc3', 'input': '1', 'expected_output': '1', 'category': 'edge', 'description': 'Single number', 'is_hidden': True}]},
            {'title': 'Reverse Linked List', 'description': 'Reverse a singly linked list.', 'difficulty': 'intermediate', 'domain': 'linked_lists', 'constraints': {'input_size': '0 ≤ n ≤ 5000', 'value_range': '-5000 ≤ Node.val ≤ 5000'}, 'input_format': 'List of integers representing nodes', 'output_format': 'Reversed list of integers', 'example_input': '1 2 3 4 5', 'example_output': '5 4 3 2 1', 'time_limit_seconds': 2, 'test_cases': [{'id': 'tc1', 'input': '1 2 3 4 5', 'expected_output': '5 4 3 2 1', 'category': 'basic', 'description': 'Standard list', 'is_hidden': False}, {'id': 'tc2', 'input': '1 2', 'expected_output': '2 1', 'category': 'edge', 'description': 'Two nodes', 'is_hidden': False}, {'id': 'tc3', 'input': '', 'expected_output': '', 'category': 'edge', 'description': 'Empty list', 'is_hidden': True}]},
            {'title': 'Sort Array by Parity', 'description': 'Move all even integers to the beginning of the array followed by all odd integers.', 'difficulty': 'intermediate', 'domain': 'sorting', 'constraints': {'input_size': '1 ≤ n ≤ 5000', 'value_range': '0 ≤ A[i] ≤ 5000'}, 'input_format': 'Array of integers', 'output_format': 'Sorted array by parity', 'example_input': '3 1 2 4', 'example_output': '2 4 3 1', 'time_limit_seconds': 2, 'test_cases': [{'id': 'tc1', 'input': '3 1 2 4', 'expected_output': '2 4 3 1', 'category': 'basic', 'description': 'Mixed numbers', 'is_hidden': False}, {'id': 'tc2', 'input': '0', 'expected_output': '0', 'category': 'edge', 'description': 'Single zero', 'is_hidden': False}, {'id': 'tc3', 'input': '2 4 6', 'expected_output': '2 4 6', 'category': 'edge', 'description': 'All even', 'is_hidden': True}]},
        ]
